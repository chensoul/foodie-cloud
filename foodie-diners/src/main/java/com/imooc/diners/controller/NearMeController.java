...
public class NearMeController {
	 ...
	 */
	@PostMapping
	public ResultInfo updateDinerLocation(final String access_token,
	 ...
	 */
	@GetMapping
	public ResultInfo nearMe(final String access_token,
		...
		return ResultInfoUtil.buildSuccess(nearMe);
	}
