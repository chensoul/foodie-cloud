package com.chensoul.domain.user.service;

import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import com.baomidou.mybatisplus.extension.service.IService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.chensoul.domain.user.entity.User;
import com.chensoul.domain.user.mapper.UserMapper;
...
public class UserService extends ServiceImpl<UserMapper, User> implements IService<User> {
	...
	public void checkPhoneIsRegistered(final String phone) {
		final boolean exists = this.baseMapper.exists(Wrappers.<User>lambdaQuery().eq(User::getPhone, phone));
