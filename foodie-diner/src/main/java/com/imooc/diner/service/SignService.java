...
public class SignService {
	...
	@Value("${service.name.foodie-point-server}")
	 ...
	 * @return
	 */
	private int getContinuousSignCount(final Long dinerId, final LocalDateTime date) {
	 ...
	 * @return
	 */
	private static String buildSignKey(final Long dinerId, final LocalDateTime date) {
		return String.format("user:sign:%d:%s", dinerId, date.format(DateTimeFormatter.ofPattern("yyyyMM")));
	}
	 ...
	 * @return 获取的积分
	 */
	private int addpoint(final int count, final Long signInDinerId) {
